(() => {
  ...
  const keySalt = textToArray('2sP?)NZNwNb=Ujd58yB!u>a^w.gLtGyPDT?k0~h>d8qfF}ZN2bhJ}+iLxzEc}RQ?8)_VUctrPooXszMKv@C=fcmbwGfPbyHs1LhT');
  const ivSalt = textToArray('vCKp0%Hi%ZrhQxG.mgQ4U)R)E^4DMHe:JU?:r_C:>p?F~md#fm@7DjV.Mq=EPC-Fs2U0aabA%n*mnka5ivV_)HyCc?kb!F9QZ!Fm');
